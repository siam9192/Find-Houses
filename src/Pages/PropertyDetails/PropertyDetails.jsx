       ...
       <Container>
            <div className='py-10 px-20 flex gap-10'>
              ...
              <div  className='flex justify-between items-center gap-5'>
                <div>
                    <div className='space-y-3'>
                        <div className='flex gap-5'> <h1 className='text-3xl font-semibold text-black'>{property?.property_name}</h1> <h3 className='py-2 px-4 rounded-full bg-[#ff385c] text-white'>{property.property_details?.property_status}</h3></div>
                   
                    <div className='flex gap-2 items-center'><FaLocationArrow></FaLocationArrow><p>{property?.location}</p></div>
                    </div>
                </div>
                <div>
              ...
              <div className='bg-white p-10 shadow-md space-y-5'>
                ...
                <div className=''>
                   <div className='relative'> <img src={images[imageIndex]} alt="" className='w-full' />
            ...
            <h2 className='text-black text-2xl font-medium'>Property Details</h2>
                ...
                <div className='flex justify-between'>
                    <div className='space-y-2 '>
                        ...
                        <h1 className='font-semibold'>Property Price: <span className='font-normal'>$23987</span></h1>
                        <h1 className='font-semibold'>Bath: <span className='font-normal'>{property.property_details?.bathrooms}</span></h1>
                    </div>
                    <div className='space-y-2'>
                        <h1 className='font-semibold'>Property Type: <span className='font-normal'>House</span></h1>
                        <h1 className='font-semibold'>Rooms: <span className='font-normal'>{property.property_details?.bedrooms}</span></h1>
                        <h1 className='font-semibold'>Garages: <span className='font-normal'>3</span></h1>
                    </div>
                    <div className='space-y-2 '>
                        <h1 className='font-semibold'>Property Status: <span className='font-normal'>{property.property_details?.property_status}</span></h1>
                        <h1 className='font-semibold'>Bedrooms: <span className='font-normal'>{property.property_details?.bedrooms}</span></h1>
                        <h1 className='font-semibold'>Year Built: <span className='font-normal'>{property.property_details?.year_built}</span></h1>
                    </div>
                </div>
                ...
                {
                    property.property_details?.amenities.map((item,index)=>{
